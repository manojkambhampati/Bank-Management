...
public class CustomerDto {
	...
	public CustomerDto(String customer_number, String firstname, String middlename, String lastname,
			String customer_city, String customer_contact_no, String occupation, String customer_date_of_birth) {
		super();
